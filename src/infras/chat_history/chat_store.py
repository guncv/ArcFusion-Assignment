...
from infrastructure.chat_history.postgres_chat_history import PostgresChatMessageHistory


class ChatHistoryStore:

    def __init__(self):
        self.backend = config.get("chat_history", {}).get("backend", "postgres")
    ...
    def get_session_history(self, session_id: str) -> BaseChatMessageHistory:
        if self.backend == "postgres":
            return self._get_postgres_history(session_id)
    ...
    def _get_postgres_history(self, session_id: str) -> PostgresChatMessageHistory:
        """Get PostgreSQL-based chat history for a session."""
