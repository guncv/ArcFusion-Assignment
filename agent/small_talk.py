...
from prompts.smalltalk_agent_prompt import SMALLTALK_AGENT_PROMPT_TEMPLATE
...
class SmallTalkAgent:
    def __init__(self):
        ...
        self.chain = SMALLTALK_AGENT_PROMPT_TEMPLATE | self.llm | StrOutputParser()
    ...
    async def invoke(self, state: WorkflowState) -> WorkflowState:
        try:
            ...
            logger.error(f"[SmallTalkAgent] Error during invoke: {e}")
